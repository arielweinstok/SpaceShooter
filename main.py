...
ORANGE_SPACE_SHIP = pygame.image.load(os.path.join("assets", "orangeShip.png"))
PINK_SPACE_SHIP = pygame.image.load(os.path.join("assets", "pinkShip.png"))

# Lasers
RED_LASER = pygame.image.load(os.path.join("assets", "shotRed.png"))
PINK_LASER = pygame.image.load(os.path.join("assets", "shotPink.png"))
ORANGE_LASER = pygame.image.load(os.path.join("assets", "shotOrange.png"))

# Player
PLAYER_SPACE_SHIP = pygame.image.load(os.path.join("assets", "playerShip.png"))
PLAYER_LASER = pygame.image.load(os.path.join("assets", "shotBase.png"))
...
class Ship:
    ...
    def shoot(self):
        if self.cool_down_counter == 0:
            laser = Laser(self.x + int((self.get_width() / 2)-5), self.y, self.lasers_img)
...
class Enemy(Ship):
    COLOR_MAP = {"red": (RED_SPACE_SHIP, RED_LASER), "orange": (ORANGE_SPACE_SHIP, ORANGE_LASER),
